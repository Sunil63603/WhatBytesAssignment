          ...
          filteredProducts.map((product) =>
            product["card-dimensions"] === "small" ? (
              ...
              >
                ...
                <button className="bg-[#0071E3] text-white text-base font-semibold px-4 py-2 rounded-lg">
                  Add to Cart
                </button>
              </div>
            ) : (
              ...
              >
                ...
                <div className="flex flex-col flex-1 justify-between mt-8">
                  ...
                  <button className="bg-[#005cbf] text-white text-base font-semibold px-8 py-3 rounded-lg mt-2 self-start">
                    Add to Cart
                  </button>
                </div>
              </div>
